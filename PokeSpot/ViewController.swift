...
class ViewController: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate, PokemonListViewControllerDelegate {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let controller = segue.destination as? PokemonListVC {
